    ...
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
        ...
        <div className="mb-5">
          ...
          <textarea value={sintomas} onChange={ (e) => setSintomas(e.target.value)} className="w-full" placeholder="Describe los Sintomas" name="" id="sintomas"></textarea>
        </div>

        <input value={ paciente.id ? 'Editar Paciente' : 'Agregar Paciente' } type="submit" className="cursor-pointer bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 transition-all" />
      </form>
    </div>
  )
}
